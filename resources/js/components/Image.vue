<template>
    <div>
        <b-container fluid class="bg-dark border border-light p-5 text-white" style="background-image:url('background-image.png'); background-repeat:no-repeat; background-size:cover;">
